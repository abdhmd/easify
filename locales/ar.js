...
export const ar = {
  ...
  contact: {
    ...
    body: "نحن نتطلع دائمًا للتواصل مع زوارنا الكرام إذا كنت تحتاج إلى خدماتنا أو كان لديك أي استفسار أو ملاحظة أو اقتراح فلا تتردد في التواصل معنا",
    social: {
      title: "مواقع التواصل الخاصة بنا ",
    },
    email: {
